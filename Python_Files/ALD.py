...
#         right_curverad = ((1 + (2*right_fit[0]*y_eval + right_fit[1])**2)**1.5) / np.absolute(2*right_fit[0])
	...
	def display_on_frame(self, image, left_curverad, right_curverad, car_off):
		...
		curve_disp_txt_1 = 'Curvature: Right = ' + str(np.round(right_curverad,2)) + 'm'
		curve_disp_txt_2 = 'Curvature: Left = ' + str(np.round(left_curverad,2)) + 'm' 

		off_disp_txt = 'Car off by ' + str(np.round(car_off,2)) + 'm'

		cv2.putText(image, curve_disp_txt_1, (30, 60), font, 1, (0,0,0), 2)
		cv2.putText(image, curve_disp_txt_2, (30, 90), font, 1, (0,0,0), 2)
		cv2.putText(image, off_disp_txt, (30, 120), font, 1, (0,0,0), 2)
