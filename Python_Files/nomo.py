...
def select_white_yellow(image):
	...
	yellow_mask = cv2.inRange(converted, lower, upper) # the lower and upper are arrays of HSV values according to the inRange syntax
	# combining masks
